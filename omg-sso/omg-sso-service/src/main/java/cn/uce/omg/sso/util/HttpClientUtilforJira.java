...
public class HttpClientUtilforJira {
    ...
    private static String sendHttpGet(HttpGet httpGet) {
        ...
        try {
            ...
            log.info("请求快运SSO token校验接口结果:" + response);
            // 得到响应实例
            HttpEntity entity = response.getEntity();
            // 判断响应状态
            if (response.getStatusLine().getStatusCode() >= 300) {
    ...
    public static String sendHttpGet(String httpUrl) {
        ...
        httpGet.setHeader("User-Agent","Chrome/69.0.3497.81 Safari/537.36");
     ...
     */
    public File BaseFile(String imageBase, String imageBaseName) {
     ...
     * @date 2019年3月13日下午5:37:06
     */
    public File BaseFile(MultipartFile file) {
