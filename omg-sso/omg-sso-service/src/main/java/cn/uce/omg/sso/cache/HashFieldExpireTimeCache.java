/** 
 * @项目名称: FSP
 * @文件名称: HashFieldExpireTimeCache extends BoundZSetRedisSupport<String> 
 * @version 2.0
 ...
 * @param <T> redis中存放的对象
 */
public class HashFieldExpireTimeCache extends BoundZSetRedisSupport<String> {
	
	/**
	 * key默认值为“存放的对象的简单类名:hash”,可在之类中覆盖默认key
	 */
	public HashFieldExpireTimeCache() {
		super.hkey = "hashFeildExpireTime:zset";
	}
