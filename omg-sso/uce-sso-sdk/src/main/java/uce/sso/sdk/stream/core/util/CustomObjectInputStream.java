/** 
 * @项目名称: FSP
 * @文件名称: CustomObjectInputStream extends ObjectInputStream 
 * @version 2.0
...
/**
 * CustomObjectInputStream extends ObjectInputStream  
 * @Description: CustomObjectInputStream extends ObjectInputStream  
 * @author automatic 
