 ...
 * @see uce.sso.sdk.stream.XStream#alias(String, Class)
 * @see uce.sso.sdk.stream.XStream#alias(String, Class, Class)
 * @see uce.sso.sdk.stream.XStream#addDefaultImplementation(Class, Class)
 */
