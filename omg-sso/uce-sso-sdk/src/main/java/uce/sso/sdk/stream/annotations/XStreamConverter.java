 ...
 * <ul>
 * <li>{@link uce.sso.sdk.stream.mapper.Mapper}: The current mapper chain of the XStream
 * instance.</li>
 * <li>{@link uce.sso.sdk.stream.core.ClassLoaderReference}: The reference to the class
 * loader used by the XStream instance to deserialize the objects.</li>
 * <li>{@link uce.sso.sdk.stream.converters.reflection.ReflectionProvider}: The reflection
 * provider used by the reflection based converters of the current XStream instance.</li>
 * <li>{@link uce.sso.sdk.stream.converters.ConverterLookup}: The lookup for converters
 ...
 * {@link uce.sso.sdk.stream.annotations.XStreamConverters} or {@link #useImplicitType()}
 * == false.</li>
 * <li>{@link uce.sso.sdk.stream.core.JVM}: Utility e.g. to load classes.</li>
 ...
 * {@link uce.sso.sdk.stream.converters.ConverterMatcher} as well as
 * {@link uce.sso.sdk.stream.converters.SingleValueConverter} extend this interface. The
 * {@link uce.sso.sdk.stream.mapper.AnnotationMapper} can only handle these two
