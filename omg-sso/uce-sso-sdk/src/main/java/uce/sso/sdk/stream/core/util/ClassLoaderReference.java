 ...
 * @since 1.1.1
 * @deprecated As of 1.4.5 use {@link uce.sso.sdk.stream.core.ClassLoaderReference} instead
 */
public class ClassLoaderReference extends ClassLoader {
     ...
     *             {@link uce.sso.sdk.stream.core.ClassLoaderReference#ClassLoaderReference(ClassLoader)}
     *             instead
     */
    ...
    /**
     * @deprecated As of 1.4.5 use
     *             {@link uce.sso.sdk.stream.core.ClassLoaderReference#getReference()}
    ...
    /**
     * @deprecated As of 1.4.5 use
     *             {@link uce.sso.sdk.stream.core.ClassLoaderReference#setReference(ClassLoader)}
     *             instead
     */
