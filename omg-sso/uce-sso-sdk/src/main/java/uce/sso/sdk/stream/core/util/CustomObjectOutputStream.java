/** 
 * @项目名称: FSP
 * @文件名称: CustomObjectOutputStream extends ObjectOutputStream 
 * @version 2.0
...
/**
 * CustomObjectOutputStream extends ObjectOutputStream  
 * @Description: CustomObjectOutputStream extends ObjectOutputStream  
 * @author automatic 
...
public class CustomObjectOutputStream extends ObjectOutputStream {
     ...
     *
     * @see #getInstance(uce.sso.sdk.stream.converters.DataHolder, uce.sso.sdk.stream.core.util.CustomObjectOutputStream.StreamCallback)
     */
