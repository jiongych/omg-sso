...
import uce.sso.sdk.stream.converters.SingleValueConverterWrapper;
import uce.sso.sdk.stream.converters.basic.BigDecimalConverter;
import uce.sso.sdk.stream.converters.basic.BigIntegerConverter;
import uce.sso.sdk.stream.converters.basic.BooleanConverter;
import uce.sso.sdk.stream.converters.basic.ByteConverter;
import uce.sso.sdk.stream.converters.basic.CharConverter;
import uce.sso.sdk.stream.converters.basic.DateConverter;
import uce.sso.sdk.stream.converters.basic.DoubleConverter;
import uce.sso.sdk.stream.converters.basic.FloatConverter;
import uce.sso.sdk.stream.converters.basic.IntConverter;
import uce.sso.sdk.stream.converters.basic.LongConverter;
import uce.sso.sdk.stream.converters.basic.NullConverter;
import uce.sso.sdk.stream.converters.basic.ShortConverter;
import uce.sso.sdk.stream.converters.basic.StringBufferConverter;
import uce.sso.sdk.stream.converters.basic.StringConverter;
import uce.sso.sdk.stream.converters.basic.URIConverter;
import uce.sso.sdk.stream.converters.basic.URLConverter;
import uce.sso.sdk.stream.converters.collections.ArrayConverter;
import uce.sso.sdk.stream.converters.collections.BitSetConverter;
import uce.sso.sdk.stream.converters.collections.CharArrayConverter;
import uce.sso.sdk.stream.converters.collections.CollectionConverter;
import uce.sso.sdk.stream.converters.collections.MapConverter;
import uce.sso.sdk.stream.converters.collections.PropertiesConverter;
import uce.sso.sdk.stream.converters.collections.SingletonCollectionConverter;
import uce.sso.sdk.stream.converters.collections.SingletonMapConverter;
import uce.sso.sdk.stream.converters.collections.TreeMapConverter;
import uce.sso.sdk.stream.converters.collections.TreeSetConverter;
import uce.sso.sdk.stream.converters.extended.ColorConverter;
import uce.sso.sdk.stream.converters.extended.DynamicProxyConverter;
import uce.sso.sdk.stream.converters.extended.EncodedByteArrayConverter;
import uce.sso.sdk.stream.converters.extended.FileConverter;
import uce.sso.sdk.stream.converters.extended.FontConverter;
import uce.sso.sdk.stream.converters.extended.GregorianCalendarConverter;
import uce.sso.sdk.stream.converters.extended.JavaClassConverter;
import uce.sso.sdk.stream.converters.extended.JavaFieldConverter;
import uce.sso.sdk.stream.converters.extended.JavaMethodConverter;
import uce.sso.sdk.stream.converters.extended.LocaleConverter;
import uce.sso.sdk.stream.converters.extended.LookAndFeelConverter;
import uce.sso.sdk.stream.converters.extended.SqlDateConverter;
import uce.sso.sdk.stream.converters.extended.SqlTimeConverter;
import uce.sso.sdk.stream.converters.extended.SqlTimestampConverter;
import uce.sso.sdk.stream.converters.extended.TextAttributeConverter;
import uce.sso.sdk.stream.converters.reflection.ExternalizableConverter;
import uce.sso.sdk.stream.converters.reflection.ReflectionConverter;
import uce.sso.sdk.stream.converters.reflection.ReflectionProvider;
import uce.sso.sdk.stream.converters.reflection.SerializableConverter;
import uce.sso.sdk.stream.core.ClassLoaderReference;
import uce.sso.sdk.stream.core.DefaultConverterLookup;
import uce.sso.sdk.stream.core.JVM;
import uce.sso.sdk.stream.core.MapBackedDataHolder;
import uce.sso.sdk.stream.core.ReferenceByIdMarshallingStrategy;
import uce.sso.sdk.stream.core.ReferenceByXPathMarshallingStrategy;
import uce.sso.sdk.stream.core.TreeMarshallingStrategy;
import uce.sso.sdk.stream.core.util.CompositeClassLoader;
import uce.sso.sdk.stream.core.util.CustomObjectInputStream;
import uce.sso.sdk.stream.core.util.CustomObjectOutputStream;
import uce.sso.sdk.stream.core.util.SelfStreamingInstanceChecker;
import uce.sso.sdk.stream.io.HierarchicalStreamDriver;
import uce.sso.sdk.stream.io.HierarchicalStreamReader;
import uce.sso.sdk.stream.io.HierarchicalStreamWriter;
import uce.sso.sdk.stream.io.StatefulWriter;
import uce.sso.sdk.stream.io.xml.DomDriver;
import uce.sso.sdk.stream.io.xml.XppDriver;
import uce.sso.sdk.stream.mapper.AnnotationConfiguration;
import uce.sso.sdk.stream.mapper.ArrayMapper;
import uce.sso.sdk.stream.mapper.AttributeAliasingMapper;
import uce.sso.sdk.stream.mapper.AttributeMapper;
import uce.sso.sdk.stream.mapper.CachingMapper;
import uce.sso.sdk.stream.mapper.ClassAliasingMapper;
import uce.sso.sdk.stream.mapper.DefaultImplementationsMapper;
import uce.sso.sdk.stream.mapper.DefaultMapper;
import uce.sso.sdk.stream.mapper.DynamicProxyMapper;
import uce.sso.sdk.stream.mapper.FieldAliasingMapper;
import uce.sso.sdk.stream.mapper.ImmutableTypesMapper;
import uce.sso.sdk.stream.mapper.ImplicitCollectionMapper;
import uce.sso.sdk.stream.mapper.LocalConversionMapper;
import uce.sso.sdk.stream.mapper.Mapper;
import uce.sso.sdk.stream.mapper.MapperWrapper;
import uce.sso.sdk.stream.mapper.OuterClassMapper;
import uce.sso.sdk.stream.mapper.PackageAliasingMapper;
import uce.sso.sdk.stream.mapper.SecurityMapper;
import uce.sso.sdk.stream.mapper.SystemAttributeAliasingMapper;
import uce.sso.sdk.stream.mapper.XStream11XmlFriendlyMapper;
import uce.sso.sdk.stream.security.AnyTypePermission;
import uce.sso.sdk.stream.security.ExplicitTypePermission;
import uce.sso.sdk.stream.security.NoPermission;
import uce.sso.sdk.stream.security.NoTypePermission;
import uce.sso.sdk.stream.security.RegExpTypePermission;
import uce.sso.sdk.stream.security.TypeHierarchyPermission;
import uce.sso.sdk.stream.security.TypePermission;
import uce.sso.sdk.stream.security.WildcardTypePermission;
 ...
 * 
 * <p>
 * XStream contains a map of {@link uce.sso.sdk.stream.converters.Converter} instances, each
 ...
 * non-standard converters are supplied in the {@link uce.sso.sdk.stream.converters.extended}
 * package and you can create your own by implementing the
 * {@link uce.sso.sdk.stream.converters.Converter} interface.
 * </p>
 * 
 * <p>
 * <hr>
 ...
 * {@link uce.sso.sdk.stream.converters.reflection.ReflectionConverter} as the fallback
 * converter.
 * </p>
 * 
 * <p>
...
public class XStream {
    ...
    private static final String ANNOTATION_MAPPER_TYPE = "uce.sso.sdk.stream.mapper.AnnotationMapper";
    ...
    private Mapper buildMapper() {
        ...
        if (JVM.is15()) {
            mapper = buildMapperDynamically(
                "uce.sso.sdk.stream.mapper.EnumMapper", new Class[]{Mapper.class},
                new Object[]{mapper});
        }
    ...
    private Mapper buildMapperDynamically(String className, Class[] constructorParamTypes,
        ...
        try {
            ...
            throw new uce.sso.sdk.stream.InitializationException(
    ...
    protected void setupConverters() {
        ...
        if (JVM.is14()) {
            ...
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.SubjectConverter",
                PRIORITY_NORMAL, new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.ThrowableConverter",
                PRIORITY_NORMAL, new Class[]{ConverterLookup.class},
                new Object[]{converterLookup});
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.StackTraceElementConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.CurrencyConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.RegexPatternConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.extended.CharsetConverter",
                PRIORITY_NORMAL, null, null);
        }
        ...
        if (JVM.is15()) {
            ...
            if (JVM.loadClassForName("javax.xml.datatype.Duration") != null) {
                registerConverterDynamically(
                    "uce.sso.sdk.stream.converters.extended.DurationConverter",
                    PRIORITY_NORMAL, null, null);
            }
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.enums.EnumConverter", PRIORITY_NORMAL,
                null, null);
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.enums.EnumSetConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.enums.EnumMapConverter", PRIORITY_NORMAL,
                new Class[]{Mapper.class}, new Object[]{mapper});
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.basic.StringBuilderConverter",
                PRIORITY_NORMAL, null, null);
            registerConverterDynamically(
                "uce.sso.sdk.stream.converters.basic.UUIDConverter", PRIORITY_NORMAL,
                null, null);
        }
    ...
    public void alias(String name, Class type) {
        if (classAliasingMapper == null) {
            throw new uce.sso.sdk.stream.InitializationException("No "
     ...
     * </p>
     * 
     * @see #createObjectOutputStream(uce.sso.sdk.stream.io.HierarchicalStreamWriter,
     *      String)
     * @see #createObjectInputStream(uce.sso.sdk.stream.io.HierarchicalStreamReader)
     * @since 1.0.3
     */
    ...
    /**
     * @deprecated As of 1.3, use {@link uce.sso.sdk.stream.InitializationException}
     *             instead
     */
    public static class InitializationException extends XStreamException {
        /**
         * @deprecated As of 1.3, use
         *             {@link uce.sso.sdk.stream.InitializationException#InitializationException(String, Throwable)}
         *             instead
         */
        ...
        /**
         * @deprecated As of 1.3, use
         *             {@link uce.sso.sdk.stream.InitializationException#InitializationException(String)}
         *             instead
         */
