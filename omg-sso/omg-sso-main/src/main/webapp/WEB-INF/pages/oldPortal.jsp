...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/portal-index.css">
	<style type="text/css">
...
<body>
	...
	<div id="vueScope" :class="settings.themes" v-cloak>
		...
		<article class="uce-layout">
			<!--菜单-->
			<div id="vuedom" class="vuedom" style="display: flex;">
				<!-- <div class="menu-type">
				...
				<div style="width:300px;height: calc(100% - 40px);">
					<div style="flex: 1;height:100%;overflow-y: auto;overflow-x: hidden;">
						<div class="jquery-accordion-menu red" style="min-width:100%;width:100%;" v-cloak>
							<ul id="demo-list">
								<li id="homepage" class="" @click="openTab('首页','${pageContext.request.contextPath}/login/home.do',false,0,'SSO',false)">
						...
						<div id="jquery-accordion-menu" class="jquery-accordion-menu red" style="min-width:100%;width:100%;" v-cloak>
							<ul id="demo-list">
								<items v-for="item in dataMenu" :model="item" :type="menuType"></items>
							</ul>
						</div>
					</div>
				...
				<div style="position: absolute;bottom: 0;width: 285px;text-align: center;line-height: 40px;color:#fff;">&copy;2018优速物流有限公司版权所有</div>
			</div>
			<!--主体内容-->
