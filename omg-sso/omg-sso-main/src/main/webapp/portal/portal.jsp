...
<html>
	<head>
		...
		<title>优速快递</title>
		<link rel="icon" type="image/png" href="/omg-sso-main/images/portal/logo_12.ico"/>
	...
	<body>
		<header class="header">
			<div  class="left">
				<img alt="logo" src="${pageContext.request.contextPath}/images/uc56_logo_202006.png" style="width:70px;height:46px;padding: 0 0 0 10px;">
   ...
   <div id="winPassword" class="easyui-dialog" data-options="title:'修改密码',closed:true"
    ...
    <div class="easyui-layout" data-options="fit:true">
		...
		<script type="text/javascript">
		   //总部
		   var headquarters = ["NOS","PRS","DAR","WPM","UBS","EBU","GIS","OMG","OMS"];
		   //财务中心
		   var financialCenter = ["NOS","PRS","DAR","UBS","EBU","GIS","OMG","OMS"];
		   //分拨中心
		   var distributionCenter = ["NOS","PRS","DAR","WPM","UBS","EBU","GIS","OMS"];
		   //网点
		   var outlets = ["NOS","PRS","DAR","UBS","EBU","GIS","CCP","OMG","OMS"]; //"NOS"
		   //承包区
		   var contractArea = ["NOS","PRS","DAR","UBS","EBU","GIS","CCP","OMG","OMS"]; 
