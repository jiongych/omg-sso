 ...
 * @date 2017/8/30 11:19
 */
public abstract class CaptchaUtil extends RandomsUtil {
    ...
    protected Font getFont(int size) {
         ...
         font[5] = new Font("Verdana", Font.ITALIC | Font.BOLD, size);
         return font[num(6)];
    }
     ...
     * @param os 输出流
     */
    public abstract String outToString() ;
    /**
     * 获取随机字符串
     *
     * @return string
