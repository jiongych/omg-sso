...
public class PortalDictTypeVo extends BaseVo {
    ...
    private String excludeTypeClassCode;
    
    /** 所属系统. */
    private String systemCode;

    public String getExcludeTypeClassCode() {
		return excludeTypeClassCode;
	}

	public void setExcludeTypeClassCode(String excludeTypeClassCode) {
		this.excludeTypeClassCode = excludeTypeClassCode;
	}
