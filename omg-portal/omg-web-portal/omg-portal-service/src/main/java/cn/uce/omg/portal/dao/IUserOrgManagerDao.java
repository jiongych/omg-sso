...
@Repository("userOrgManagerDao")
public interface IUserOrgManagerDao extends IBaseDao<PortalUserOrgManager, Long>{
	 ...
	 */
	int deleteUserOrgManagerByEmpCode(String empCode);
