...
public class ExpandMenuTreeCache extends CacheSupport<List<PortalMenuTreeVo>>{
	...
	public List<PortalMenuTreeVo> doGet(String arg0) throws BusinessException {
		...
		return portalMenuBiz.findExpandMenuTree( JSON.parseObject(arg0, CurrentUser.class));
	}
