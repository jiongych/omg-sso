    ...
    if (!PDFJS.disableTextLayer) {
	  ...
	  var cover = document.createElement('div');
       ...
       for (var i=0;i<vars.length;i++) {
               ...
               if(pair[0] == "watermark"){
				   var paramW = decodeURI(decodeURI(pair[1]));
				   watermark = paramW.replace("?","");
			   }
       }
		
		var defaultSettings = {
			watermark_txt: watermark,
			watermark_x: 0,//ˮӡ��ʼλ��x�����
			watermark_y: 0,//ˮӡ��ʼλ��Y�����
			watermark_rows: 30,//ˮӡ����
			watermark_cols: 100,//ˮӡ����
			watermark_x_space: 10,//ˮӡx����
			watermark_y_space: 10,//ˮӡy����
			watermark_color: '#a0a0a0',//ˮӡ������ɫ
			watermark_alpha: 0.3,//ˮӡ͸����
			watermark_fontsize: '20px',//ˮӡ�����С
			watermark_font: '΢���ź�',//ˮӡ����
			watermark_width: 120,//ˮӡ���
			watermark_height: 80,//ˮӡ����
			watermark_angle: 45//ˮӡ��б����
		};
