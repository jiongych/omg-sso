 ...
 *
 */
public class PortalRankingStatisticsTask extends UceSimpleJob {
	private Logger log = LoggerFactory.getLogger(PortalRankingStatisticsTask.class);
	@Autowired
	...
	public void doExecute(ShardingContext context) {
		...
		browerStatisticsBiz.rankingStatistics(bsiv);
