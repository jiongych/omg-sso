...
/**
 * 该JOB用于定时计算最近30日分辨率统计数据
 * @author uce
 *
 */
public class PortalScreenStatisticsTask extends UceSimpleJob {
	private Logger log = LoggerFactory.getLogger(PortalScreenStatisticsTask.class);
	@Autowired
	...
	public void doExecute(ShardingContext context) {
		...
		browerStatisticsBiz.screenStatistics(bsiv);
