 ...
 *
 */
public class PortalLoginStatisticsTask extends UceSimpleJob {
	private Logger log = LoggerFactory.getLogger(PortalLoginStatisticsTask.class);
	@Autowired
	...
	public void doExecute(ShardingContext context) {
		...
		browerStatisticsBiz.loginStatistics(bsiv);
