...
ColumnStateful.prototype = {
    ...
    saveState: function () {
        ...
        var json = mini.encode(state);
		window.localStorage[me.getStateId()] = json;
    ...
    restoreState: function () {
		...
		var json = window.localStorage[me.getStateId()]
        if (json && json != "null") {
                ...
                function eachColumns(gridColumns, stateColumns) {
                    ...
                    for (var i = 0, l = stateColumns.length; i < l; i++) {
                        ...
                        if (column) {
                            ...
                            var newColumn = {};
                            newColumn.width = colState.width;
                            newColumn.visible = colState.visible;
                           if(colState.header) newColumn.header = colState.header;
                           if(colState.field) newColumn.field = colState.field;
                            newGridColumns.push(newColumn);
